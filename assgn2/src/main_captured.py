...
if __name__=="__main__":
    ...
    if args.tonemap_type=='xyz':
        I_hdr = tonemap_xyz(I_hdr, 0.2, 0.85)
    ...
    savename = f"{args.raw_or_jpg}_{args.weight_func}_{args.lin_or_log}_{args.tonemap_type}_captured_k02_b085.jpg"
