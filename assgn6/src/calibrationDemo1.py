...
objName = 'obj1' #object name (should correspond to a dir in data)
seqName = 'v1' #sequence name (subdirectory of object)
calName = 'calib_cptr' #calibration sourse (also a dir in data)
...
dX = 257.0 #calibration plane length in x direction
dY = 184.0 #calibration plane length in y direction
